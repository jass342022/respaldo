...
const Home = () => {
  ...
  const handleChangeInput = (e) => {
    let loadCharactersCopy = [];
    if (e.target.value !== "") {
      if (loadCharacters?.characters) {
        loadCharacters?.characters.forEach(function (characters) {
          if (
            characters.name.toUpperCase().includes(e.target.value.toUpperCase())
          ) {
            loadCharactersCopy.push(characters);
          }
        });
        setLoadCharacters({
          ...loadCharacters,
          characters: loadCharactersCopy,
        });

        console.log(loadCharactersCopy);
      }
    } else {
      getCharacters();
    }
